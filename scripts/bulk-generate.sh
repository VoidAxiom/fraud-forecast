...
#   LIVE_RATE_MULTIPLIER — passed to python -m simulator.bulk_generate (default 1.0)
...
LIVE_RATE_MULTIPLIER="${LIVE_RATE_MULTIPLIER:-1.0}"
...
echo "[bulk-generate] COMPOSE_PROJECT_NAME=$COMPOSE_PROJECT_NAME LIVE_RATE_MULTIPLIER=$LIVE_RATE_MULTIPLIER"
...
docker compose run --rm \
  -e LIVE_RATE_MULTIPLIER="$LIVE_RATE_MULTIPLIER" \
